          ...
          <div className="flex-1 overflow-y-auto">
            {projects.map((project, index) => (
              <div
                ...
                className={`px-4 py-3 cursor-pointer transition-colors group flex items-center justify-between
              ...
              >
                ...
                <div className="flex items-center space-x-2">
                  <button
                    ...
                    className="p-1 rounded hover:bg-gray-600 text-gray-400 hover:text-gray-200 opacity-0 group-hover:opacity-100
                  ...
                  <button
                    ...
                    className="p-1 rounded hover:bg-gray-600 text-gray-400 hover:text-red-400 opacity-0 group-hover:opacity-100
                             transition-all duration-200"
                  >
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
